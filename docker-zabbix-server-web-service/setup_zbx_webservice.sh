...
docker-compose --env-file ../../configs/.env -f docker-compose-server-web-service.yml build

log "Iniciando contêiner do Zabbix Server..."
docker-compose --env-file ../../configs/.env -f docker-compose-server-web-service.yml up -d
